...
import { IOriginalStyle, IUseScrollLockOptions, IUseScrollLockReturn } from "./use-scroll-lock.types";

const IS_SERVER = typeof window === "undefined";

const useScrollLock = (options: IUseScrollLockOptions = {}): IUseScrollLockReturn => {
